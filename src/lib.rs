...
pub fn init_centroids(data: &Vec<Vec<[u8; 4]>>, means: u16) -> Vec<(f64,f64,f64)> {
...
pub fn tup3_add(mut tuple_one: (f64, f64, f64), tuple_two: &(f64, f64, f64)) -> (f64, f64, f64) {
...
pub fn get_distance_3d (to: &(f64, f64, f64), 
   ...
   let distance = (dx.abs() + dy.abs() + dz.abs()).powf(1.0 / p);
